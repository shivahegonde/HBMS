...
class CLuxaryRoom extends Room {
    //int count=0;
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    Connection con=DBConnect.connection();
    Scanner scanner=new Scanner(System.in);

    CLuxaryRoom() throws SQLException, ClassNotFoundException {
...
//            System.out.println(j+1);
            String str = "update luxaryroom set status = 1,days=" + days + " where roomno = " + "(select min(roomno) from deluxroom where status in(0))";
