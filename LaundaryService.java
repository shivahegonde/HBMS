...
LaundaryService() throws SQLException, ClassNotFoundException {

}
    public void startLaundaryService() throws IOException, SQLException {
    ...
    private void seeYourTask() throws SQLException {
        ...
        ResultSet rs=statement.executeQuery("select * from laundary");
...
//        System.out.println("Inside RS");
    ...
    private void statusUpdate() throws SQLException {
        Statement statement=con.createStatement();
        ResultSet rs=statement.executeQuery("select * from laundary");
        String s1 = "Update laundary set status="+0+", roomno="+0+"where userid=?";
        rs.next();
